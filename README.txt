...
With Font Awesome active all the time, you can use the icon fonts anywhere on your site with basic HTML or CSS.  Visit the <a href="http://fortawesome.github.io/Font-Awesome/" target="_blank">Font Awesome</a> site to learn more.
